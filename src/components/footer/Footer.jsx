...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-pink-user-0 xl:p-56  p-8 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        <div className="container">
          <div className="flex flex-wrap -mx-4">
              ...
              <div className="w-full mb-10">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  <img
                    ...
                    alt="logo"
                    className="bg-found-user-0 w-24 p-2 border-solid border-4 border-red-user-0 rounded-full object-cover"
                  />
                </a>
                <p className="text-base mb-7 text-found-user-0 text-body-color">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo
                  similique asperiores quis voluptas cumque exercitationem, et
                  aperiam
                </p>
                <p className="flex items-center text-sm font-medium text-dark">
                  <span className="mr-3 text-primary">
                    <svg
                      ...
                      height={21}
                      viewBox="0 0 19 21"
                      className="fill-current text-red-user-0"
                    >
                  ...
                  <span className="text-red-user-0">+012 (345) 678 99</span>
                </p>
              </div>
            </div>

            <LinkGroup className="text-red-user-0" header="Resources">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                <h4 className="text-3xl  font-title text-red-user-0 mb-9 text-dark">
                  Follow us On
                </h4>
                <div className="flex items-center mb-6">
                  <a
                    href="/#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-white hover:border-red-user-0  hover:bg-red-user-0 hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={8}
                      height={16}
                ...
                <p className="text-base text-body-color text-red-user-0">
                  {" "}
                  © {new Date().getFullYear()} Luciano Melo Claps{" "}
                </p>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <span className="absolute top-10 right-10 z-[-1]"></span>
        </div>
      </footer>
    </>
  );
...
const LinkGroup = ({ children, header }) => {
  return (
    <>
      <div className="w-full font-title  text-red-user-0 px-4 sm:w-1/2 lg:w-2/12">
        <div className="w-full mb-10">
          <h4 className="text-3xl font-semibold mb-9 text-dark"> {header} </h4>
          <ul>{children}</ul>
        </div>
      </div>
    </>
  ...
  return (
    <div>
      <li>
        <a
          href={link}
          className={`inline-block mb-2 text-found-user-0  font-body text-sm leading-loose text-body-color hover:text-red-user-0`}
        >
          {label}
        </a>
      </li>
